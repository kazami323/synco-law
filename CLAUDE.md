...
Второй источник (30.08.2026) — прототип заказчика «Свод»:
[docs/SVOD_PROTOTYPE_DELTA.md](docs/SVOD_PROTOTYPE_DELTA.md). Он задаёт
пересборку подачи модулей и добавляет требования сверх ТЗ, но **не отменяет
его**: шесть продуктовых развилок открыты, до ответов заказчика источник
истины — `FUNCTIONAL_SPEC.md`.
