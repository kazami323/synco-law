...
| AI | Anthropic API (`Codex-opus-4-8`), агенты в `backend/app/agents/` |
...
В [.Codex/agents/](.Codex/agents/) лежат специализированные субагенты.
Правила вызова — в [.Codex/agents/README.md](.Codex/agents/README.md).
